...
function del() {
    ...
    //reset timer to 0
    firsttime = true;
            document.getElementById("Classificacao").children[lastid].children[0].remove();
...
function fstart() {
    ...
    var x = setInterval(function () {
        if (document.getElementById("Classificacao").children.length > 1)
        {
            for (k = 0; k < document.getElementById("Classificacao").children.length; k++) {
                if (document.getElementsByClassName("timer").length > 0 && document.getElementById("Classificacao").children.length > 0) {
                    if (document.getElementById("Classificacao").children[k].children[0] == document.getElementsByClassName("timer")[0].parentElement) 
                    {
                        lastid = k;
                    }
                }
